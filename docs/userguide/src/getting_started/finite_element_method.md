...
(e.g. displacement) across the whole domain. [Multi-Point
Motion](./multi_point_motion.md#point-grid) (covered later in this book)
builds exactly this kind of nodal point collection and, in [Tracking the
Grid](./multi_point_motion.md#tracking-the-grid), tracks every one of its
