...
write(photo, "astronaut_translate_original.png")

translated = translate(photo, dx=-60, dy=80)
write(translated, "astronaut_translate_rigid_body.png")
```

```text
<!-- cmdrun python3 -c "import dictk; from dictk.image import translate, write; photo = dictk.astronaut(300, 300); write(photo, 'astronaut_translate_original.png'); translated = translate(photo, dx=-60, dy=80); write(translated, 'astronaut_translate_rigid_body.png'); print('Saved: astronaut_translate_original.png, astronaut_translate_rigid_body.png')" -->
```
...
photo = dictk.astronaut(300, 300)
write(photo, "astronaut_rotate_original.png")

rotated = rotate(photo, 30.0)
write(rotated, "astronaut_rotate_30deg.png")
```

```text
<!-- cmdrun python3 -c "import dictk; from dictk.image import rotate, write; photo = dictk.astronaut(300, 300); write(photo, 'astronaut_rotate_original.png'); rotated = rotate(photo, 30.0); write(rotated, 'astronaut_rotate_30deg.png'); print('Saved: astronaut_rotate_original.png, astronaut_rotate_30deg.png')" -->
```
...
photo = dictk.astronaut(300, 300)
write(photo, "astronaut_stretch_original.png")

stretch_5pct = stretch(photo, factor_x=1.05)
write(stretch_5pct, "astronaut_stretch_x_5pct.png")

stretch_50pct = stretch(photo, factor_x=1.50)
write(stretch_50pct, "astronaut_stretch_x_50pct.png")
```

```text
<!-- cmdrun python3 -c "import dictk; from dictk.image import stretch, write; photo = dictk.astronaut(300, 300); write(photo, 'astronaut_stretch_original.png'); write(stretch(photo, factor_x=1.05), 'astronaut_stretch_x_5pct.png'); write(stretch(photo, factor_x=1.50), 'astronaut_stretch_x_50pct.png'); print('Saved: astronaut_stretch_original.png, astronaut_stretch_x_5pct.png, astronaut_stretch_x_50pct.png')" -->
```
...
photo = dictk.astronaut(300, 300)
write(photo, "astronaut_compress_original.png")

compress_neg5pct = stretch(photo, factor_y=0.95)
write(compress_neg5pct, "astronaut_compress_y_neg5pct.png")

compress_neg50pct = stretch(photo, factor_y=0.50)
write(compress_neg50pct, "astronaut_compress_y_neg50pct.png")
```

```text
<!-- cmdrun python3 -c "import dictk; from dictk.image import stretch, write; photo = dictk.astronaut(300, 300); write(photo, 'astronaut_compress_original.png'); write(stretch(photo, factor_y=0.95), 'astronaut_compress_y_neg5pct.png'); write(stretch(photo, factor_y=0.50), 'astronaut_compress_y_neg50pct.png'); print('Saved: astronaut_compress_original.png, astronaut_compress_y_neg5pct.png, astronaut_compress_y_neg50pct.png')" -->
```
...
photo = dictk.astronaut(300, 300)
write(photo, "astronaut_shear_original.png")

sheared = shear(photo, shear_x=0.5)
write(sheared, "astronaut_shear_x_0.5.png")
```

```text
<!-- cmdrun python3 -c "import dictk; from dictk.image import shear, write; photo = dictk.astronaut(300, 300); write(photo, 'astronaut_shear_original.png'); sheared = shear(photo, shear_x=0.5); write(sheared, 'astronaut_shear_x_0.5.png'); print('Saved: astronaut_shear_original.png, astronaut_shear_x_0.5.png')" -->
```
...
photo = dictk.astronaut(300, 300)
write(photo, "astronaut_complex_original.png")

combined = complex_deform(photo, factor_x=1.3, factor_y=0.8, angle=15.0)
write(combined, "astronaut_complex_deform.png")
```

```text
<!-- cmdrun python3 -c "import dictk; from dictk.image import complex_deform, write; photo = dictk.astronaut(300, 300); write(photo, 'astronaut_complex_original.png'); combined = complex_deform(photo, factor_x=1.3, factor_y=0.8, angle=15.0); write(combined, 'astronaut_complex_deform.png'); print('Saved: astronaut_complex_original.png, astronaut_complex_deform.png')" -->
```
...
photo = dictk.astronaut(300, 300)
write(photo, "astronaut_crack_plain_original.png")

cracked_plain = crack_dislocation(photo, offset=4.0)
write(cracked_plain, "astronaut_crack_plain_dislocation.png")
```

```text
<!-- cmdrun python3 -c "import dictk; from dictk.image import crack_dislocation, write; photo = dictk.astronaut(300, 300); write(photo, 'astronaut_crack_plain_original.png'); cracked_plain = crack_dislocation(photo, offset=4.0); write(cracked_plain, 'astronaut_crack_plain_dislocation.png'); print('Saved: astronaut_crack_plain_original.png, astronaut_crack_plain_dislocation.png')" -->
```
