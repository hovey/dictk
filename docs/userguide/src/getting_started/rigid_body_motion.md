...
For the concrete example in [Figure](#fig-translational-motion), let $\bar{\boldsymbol{u}} = \langle
...
<figure id="fig-translational-motion">
    <img src="configuration_current.png" alt="configuration_current" width=75% />
    <figcaption>
