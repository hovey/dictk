...
(often of a deformed specimen) as a means to optically quantify strain experience by a specimen.
...
also lay the ground work for discrete motion of points in a finite element mesh (i.e., *nodes*), as landmarks to be located (and then correlated) across pairs of a reference and a subject image.
