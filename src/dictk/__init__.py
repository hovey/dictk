...
`dictk checkerboard`, ...) write image files to disk — that's their whole
job. The corresponding Python API functions (`dictk.rosta`,
`dictk.checkerboard`, ...) do not perform any file I/O; they return NumPy
arrays only. This keeps the API composable in a functional style — arrays
...
from dictk.imaging import checkerboard
